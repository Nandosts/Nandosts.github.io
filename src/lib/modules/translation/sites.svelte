<script lang="ts" context="module">
  ...
  export let sites = writable([] as SitesCollection[]);
  export let setSites = () => undefined as unknown;

  export let structSites = writable([] as SitesCollection[]);
</script>
  ...
  setSites = () => {
    ...
    structSites.set([
      ...
      },
      {
        ...
        description: $_("festival-brasil-cnv"),
